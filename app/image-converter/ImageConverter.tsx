...
export function ImageConverter() {
  ...
  async function convert() {
    ...
    try {
      ...
      bitmap.close();
      const blob = await encodeCanvas(canvas, format, qualityForClarity(clarity));
    ...
    <section className="tool-workspace">
      <aside className="control-panel">
        ...
        <div className="step"><span className="step-number">02</span><div>
          ...
          {(format === "image/jpeg" || format === "image/webp") && <ImageClaritySelector value={clarity} onChange={setClarity} />}
