...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Kevin6 Toolbox — Pick a tool. Get it done.",
    description: "Private, focused browser tools at kevin6.com/toolbox.",
    url: "https://kevin6.com/toolbox/",
    siteName: "Kevin6 Toolbox",
    images: [{ url: "/toolbox/og.png", width: 1792, height: 1024, alt: "Kevin6 Toolbox — Pick a tool. Get it done." }],
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Kevin6 Toolbox",
    description: "Pick a tool. Get it done.",
